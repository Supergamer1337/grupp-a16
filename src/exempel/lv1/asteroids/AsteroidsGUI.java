package exempel.lv1.asteroids;


import exempel.lv1.asteroids.objects.Asteroid;
import exempel.lv1.asteroids.objects.Spaceship;
...
import static exempel.lv1.asteroids.Asteroids.GAME_HEIGHT;
import static exempel.lv1.asteroids.Asteroids.GAME_WIDTH;
import static exempel.lv1.asteroids.objects.Spaceship.MAX_DX;
import static exempel.lv1.asteroids.objects.Spaceship.MAX_DY;
...
public class AsteroidsGUI extends Application {
    ...
    void handleKeyPressed(KeyEvent event) {
        ...
        switch (event.getCode()) {
            case LEFT -> asteroids.setShipSpeed(-MAX_DX, 0);
            case RIGHT -> asteroids.setShipSpeed(MAX_DX, 0);
            case UP -> asteroids.setShipSpeed(0, -MAX_DY);
            case DOWN -> asteroids.setShipSpeed(0, MAX_DY);
        }
    }
